...
--
+
image::../assets/images/azure-wf-inventorynode1.png[Adding an inventory source sync node, opts="border"]
...
+
image::../assets/images/azure-wf-inventorynode2.png[Adding a second node to the workflow, opts="border"]
+
--
...
+
image::../assets/images/azure-wf-jobtemplatenode1.png[Completed Azure information workflow, opts="border"]
